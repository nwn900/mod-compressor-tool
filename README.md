...
- [`releases/ModCompressorTool-Vortex-1.0.0/`](releases/ModCompressorTool-Vortex-1.0.0/) — standalone Vortex package with the required archive-root layout and `gameart.png`.
